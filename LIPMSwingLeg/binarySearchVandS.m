function [V, S] = binarySearchVandS(x, f, g, r, umat, V_init, Q_init, B, ...
...
for i=1:max_iter
  ...
  [prog, Vr_sos] = spotless_add_sprocedure(prog, Vr_sos, B, x, 0, 4);
  ...
  for j=1:2^nU
    ...
    [prog, Vdot_sos] = spotless_add_sprocedure(prog, Vdot_sos, -B, x, 0, 4);
    for k=1:nU
