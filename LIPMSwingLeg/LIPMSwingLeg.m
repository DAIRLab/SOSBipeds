classdef LIPMSwingLeg < NStepCapturabilitySOSSystem
  % Constant height, constant angular momentum model
  % Control input is the foot velocity (massless foot) and ankle torque (
  ...
  methods
    function obj = LIPMSwingLeg(g, z_nom, step_time, cop_max, u_wrt_com)
      if cop_max > 0
          num_inputs = 2;
      else
          num_inputs = 1;
      end
      obj@NStepCapturabilitySOSSystem(3, num_inputs, 0);
      obj.g = g;
      obj.z_nom = z_nom;
      obj.T = step_time;
      obj.cop_max = cop_max;
