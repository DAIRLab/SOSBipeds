...
% Domain of each mode
% Mode 1
hX{1} = [ x(1) + x(2)/omega_0; x(1) + x(2)/omega_0 - x(3)];

% Mode 2
hX{2} = [ x(1) + x(2)/omega_0; - x(1) - x(2)/omega_0 + x(3)];

% Mode 3
hX{3} = [ - x(1) - x(2)/omega_0; x(1) + x(2)/omega_0 - x(3)];

% Mode 4
hX{4} = [ - x(1) - x(2)/omega_0; - x(1) - x(2)/omega_0 + x(3)];
